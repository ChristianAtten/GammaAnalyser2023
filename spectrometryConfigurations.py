...
size = 60    # scintillator thickness
time = 5400  # time over which spectrum accumulated
...
confidence = 4  # confidence factor, f, for second difference method of peak finding
...
#CA 14.02.2023
HLD = 8190
#HLD = 1191  # higher channel number threshold, everything above will be ignored
